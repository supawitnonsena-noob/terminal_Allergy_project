  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const velodyne_msgs__msg__VelodynePacket * ros_message = static_cast<const velodyne_msgs__msg__VelodynePacket *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_velodyne_msgs__msg__VelodynePacket(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  velodyne_msgs__msg__VelodynePacket * ros_message = static_cast<velodyne_msgs__msg__VelodynePacket *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_velodyne_msgs__msg__VelodynePacket(cdr, ros_message);
}
