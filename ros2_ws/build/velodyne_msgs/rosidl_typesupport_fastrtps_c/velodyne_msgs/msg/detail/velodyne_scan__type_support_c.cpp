  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: packets
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_velodyne_msgs__msg__VelodynePacket(
        &array_ptr[i], cdr);
    }
  }
  ...
  velodyne_msgs__msg__VelodyneScan * ros_message)
{
  ...
  // Field name: packets
  {
    ...
    auto array_ptr = ros_message->packets.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_velodyne_msgs__msg__VelodynePacket(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: packets
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_velodyne_msgs__msg__VelodynePacket(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: packets
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_velodyne_msgs__msg__VelodynePacket(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: packets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_velodyne_msgs__msg__VelodynePacket(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const velodyne_msgs__msg__VelodyneScan * ros_message = static_cast<const velodyne_msgs__msg__VelodyneScan *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_velodyne_msgs__msg__VelodyneScan(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  velodyne_msgs__msg__VelodyneScan * ros_message = static_cast<velodyne_msgs__msg__VelodyneScan *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_velodyne_msgs__msg__VelodyneScan(cdr, ros_message);
}
