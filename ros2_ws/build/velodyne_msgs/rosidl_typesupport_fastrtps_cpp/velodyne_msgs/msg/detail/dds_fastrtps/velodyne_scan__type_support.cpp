...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_VelodynePacket(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: packets
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      velodyne_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.packets[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: packets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        velodyne_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.packets[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_velodyne_msgs
max_serialized_size_key_VelodyneScan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: packets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        velodyne_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_VelodynePacket(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
