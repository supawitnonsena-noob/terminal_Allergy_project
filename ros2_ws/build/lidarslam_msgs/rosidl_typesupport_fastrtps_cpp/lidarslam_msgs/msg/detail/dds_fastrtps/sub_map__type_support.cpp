...
#include "lidarslam_msgs/msg/detail/sub_map__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lidarslam_msgs::msg::SubMap;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lidarslam_msgs::msg::SubMap *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lidarslam_msgs::msg::SubMap *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SubMap__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const lidarslam_msgs::msg::SubMap *>(
...
static size_t _SubMap__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SubMap(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SubMap__callbacks = {
  "lidarslam_msgs::msg",
  "SubMap",
...
static rosidl_message_type_support_t _SubMap__handle = {
...
{
  return &lidarslam_msgs::msg::typesupport_fastrtps_cpp::_SubMap__handle;
}
