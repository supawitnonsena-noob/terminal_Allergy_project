...
bool lidarslam_msgs__msg__sub_map__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lidarslam_msgs.msg._sub_map.SubMap", full_classname_dest, 34) == 0);
  }
  lidarslam_msgs__msg__SubMap * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of SubMap */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lidarslam_msgs.msg._sub_map");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SubMap");
