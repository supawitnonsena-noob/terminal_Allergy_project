  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xdc, 0x5a, 0xdb, 0xad, 0x73, 0x4e, 0x1d, 0xac,
      0x06, 0xef, 0x2d, 0x04, 0xcb, 0x9a, 0xd5, 0x94,
      0x7f, 0x20, 0xa8, 0x1b, 0x97, 0x05, 0x76, 0x47,
      0xcd, 0x35, 0x2f, 0x5a, 0x0c, 0x7d, 0x3a, 0x2a,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t lidarslam_msgs__msg__SubMap__EXPECTED_HASH = {1, {
    0x7c, 0x86, 0x24, 0x73, 0x8e, 0xeb, 0x62, 0xb7,
    0xd7, 0x23, 0xea, 0x0b, 0x2f, 0xcc, 0xf3, 0x05,
    0xdd, 0xd1, 0xa5, 0x93, 0xed, 0xae, 0xae, 0x95,
    0x74, 0xf0, 0xe2, 0x59, 0x69, 0x51, 0xfe, 0x4b,
  }};
...
static char lidarslam_msgs__msg__MapArray__TYPE_NAME[] = "lidarslam_msgs/msg/MapArray";
static char builtin_interfaces__msg__Time__TYPE_NAME[] = "builtin_interfaces/msg/Time";
static char geometry_msgs__msg__Point__TYPE_NAME[] = "geometry_msgs/msg/Point";
static char geometry_msgs__msg__Pose__TYPE_NAME[] = "geometry_msgs/msg/Pose";
static char geometry_msgs__msg__Quaternion__TYPE_NAME[] = "geometry_msgs/msg/Quaternion";
static char lidarslam_msgs__msg__SubMap__TYPE_NAME[] = "lidarslam_msgs/msg/SubMap";
...
static char lidarslam_msgs__msg__MapArray__FIELD_NAME__header[] = "header";
static char lidarslam_msgs__msg__MapArray__FIELD_NAME__submaps[] = "submaps";
static char lidarslam_msgs__msg__MapArray__FIELD_NAME__cloud_coordinate[] = "cloud_coordinate";

static rosidl_runtime_c__type_description__Field lidarslam_msgs__msg__MapArray__FIELDS[] = {
  {
    {lidarslam_msgs__msg__MapArray__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {lidarslam_msgs__msg__MapArray__FIELD_NAME__submaps, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
      {lidarslam_msgs__msg__SubMap__TYPE_NAME, 25, 25},
    },
    {NULL, 0, 0},
  },
  {
    {lidarslam_msgs__msg__MapArray__FIELD_NAME__cloud_coordinate, 16, 16},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription lidarslam_msgs__msg__MapArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {lidarslam_msgs__msg__MapArray__TYPE_NAME, 27, 27},
      {lidarslam_msgs__msg__MapArray__FIELDS, 3, 3},
    },
    {lidarslam_msgs__msg__MapArray__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&lidarslam_msgs__msg__SubMap__EXPECTED_HASH, lidarslam_msgs__msg__SubMap__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[4].fields = lidarslam_msgs__msg__SubMap__get_type_description(NULL)->type_description.fields;
...
static char toplevel_type_raw_source[] =
  ...
  "lidarslam_msgs/SubMap[] submaps\n"
  "int8 cloud_coordinate\n"
  "int8 LOCAL = 0\n"
  "int8 GLOBAL = 1";
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *lidarslam_msgs__msg__MapArray__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *geometry_msgs__msg__Point__get_individual_type_description_source(NULL);
    sources[3] = *geometry_msgs__msg__Pose__get_individual_type_description_source(NULL);
    sources[4] = *geometry_msgs__msg__Quaternion__get_individual_type_description_source(NULL);
    sources[5] = *lidarslam_msgs__msg__SubMap__get_individual_type_description_source(NULL);
