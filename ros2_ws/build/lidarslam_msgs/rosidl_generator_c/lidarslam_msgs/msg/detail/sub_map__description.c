...
static char lidarslam_msgs__msg__SubMap__FIELD_NAME__header[] = "header";
static char lidarslam_msgs__msg__SubMap__FIELD_NAME__distance[] = "distance";
static char lidarslam_msgs__msg__SubMap__FIELD_NAME__pose[] = "pose";
static char lidarslam_msgs__msg__SubMap__FIELD_NAME__cloud[] = "cloud";

static rosidl_runtime_c__type_description__Field lidarslam_msgs__msg__SubMap__FIELDS[] = {
  {
    {lidarslam_msgs__msg__SubMap__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {lidarslam_msgs__msg__SubMap__FIELD_NAME__distance, 8, 8},
    {
  ...
  {
    {lidarslam_msgs__msg__SubMap__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {lidarslam_msgs__msg__SubMap__FIELD_NAME__cloud, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription lidarslam_msgs__msg__SubMap__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {lidarslam_msgs__msg__SubMap__FIELDS, 4, 4},
    },
    {lidarslam_msgs__msg__SubMap__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *lidarslam_msgs__msg__SubMap__get_individual_type_description_source(NULL),
