...
static const _SubMap_type_support_symbol_names_t _SubMap_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidarslam_msgs, msg, SubMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lidarslam_msgs, msg, SubMap)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lidarslam_msgs, msg, SubMap)() {
  return &::lidarslam_msgs::msg::rosidl_typesupport_c::SubMap_message_type_support_handle;
}
