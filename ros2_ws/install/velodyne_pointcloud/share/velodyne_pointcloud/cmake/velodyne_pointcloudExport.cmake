...
foreach(_cmake_expected_target IN ITEMS velodyne_pointcloud::velodyne_cloud_types velodyne_pointcloud::velodyne_rawdata velodyne_pointcloud::transform)
...
set_target_properties(velodyne_pointcloud::transform PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/velodyne_pointcloud"
  INTERFACE_LINK_LIBRARIES "diagnostic_updater::diagnostic_updater;Eigen3::Eigen;message_filters::message_filters;rclcpp::rclcpp;tf2::tf2;tf2_ros::tf2_ros;velodyne_pointcloud::velodyne_cloud_types;velodyne_pointcloud::velodyne_rawdata;yaml-cpp::yaml-cpp"
)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/velodyne_pointcloudExport-*.cmake")
